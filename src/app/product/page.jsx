    ...
    <>
      <section className={styles.product}>
        <div className={styles.imgs}>
          <IoIosArrowBack onClick={handlePrevSlide} className={styles.arrow} />
            ...
            <div className={styles.productdetail}>
              <div>
                ...
                >
                  ...
                  {productDetails && (
                    <p>
                      THE HF PANEL CAP IS A STRUCTURED CAMPER STYLE CAP WITH A
                      FIRM FLAT BRIM, PERFECT FOR ADDING A TOUCH OF URBAN FLAIR
                      LOOK. WITH ITS ADJUSTABLE DRAWSTRING AT THE BACK, YOU CAN
                      CUSTOMIZE THE FIT FOR MAXIMUM COMFORT.
                    </p>
                  )}
                </div>
              </div>
